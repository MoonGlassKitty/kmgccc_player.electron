...
function App(): React.ReactElement {
  ...
  }, [currentId, currentTrack?.sourceUrl, hasResolvedInitialHomeSnapshot, isLyricsSidebarOpen, isShuffleEnabled, lyricsSidebarWidth, playbackMode, playbackQueueIds, playbackSource, playbackTime, route, volume])
